...
class VerticalScheduleResourceHeader extends StatelessWidget {
  ...
  /// Creates an instance of [VerticalScheduleResourceHeader].
  ///
  ...
  const VerticalScheduleResourceHeader(
      {Key? key,
      required this.child,
      required this.id,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: height ?? 100,
      width: config.cellWidth!.toDouble() - 60,
      child: Center(
        child: child,
      ),
    );
